...
public class NativeImageTask extends BaseGraalCompileTask {
   ...
   *
   * @return an empty String on {@link Platform.OperatingSystem#MAC MAC} and {@link
   *     Platform.OperatingSystem#LINUX LINUX}, ".exe" on {@link Platform.OperatingSystem#WINDOWS
   *     WINDOWS}
   */
  @Override
  ...
  public final void setMainClass(final Provider<String> provider) {
