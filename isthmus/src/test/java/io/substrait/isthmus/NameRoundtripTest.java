...
public class NameRoundtripTest extends PlanTestBase {
  ...
  void preserveNamesFromSql() throws Exception {
    ...
    final var substraitToCalcite = new SubstraitToCalcite(EXTENSION_COLLECTION, typeFactory);
    ...
    final List<org.apache.calcite.rel.RelRoot> calciteRelRoots =
        s.sqlToRelNode(query, catalogReader);
    assertEquals(1, calciteRelRoots.size());

    final org.apache.calcite.rel.RelRoot calciteRelRoot1 = calciteRelRoots.get(0);
