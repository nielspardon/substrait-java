...
public class ReadRelRoundtripTest extends TestBase {
  ...
  @Test
  void namedScan() {
    final var tableName = Stream.of("a_table").collect(Collectors.toList());
    final var columnNames = Stream.of("column1", "column2").collect(Collectors.toList());
  ...
  @Test
  void emptyScan() {
    final var emptyScan = b.emptyScan();
